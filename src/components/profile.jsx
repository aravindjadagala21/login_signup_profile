...
export default function Profile() {
  return (
    <div className="min-h-screen h-screen flex justify-center items-center">
      <div className="rounded container min-w-sm max-w-lg min-h-[80%] bg-gray-100 border-gray-400 border">
        ...
        <div className="flex flex-col p-5 gap-3 border-b-gray-500 border-b border-dashed">
          <div className="container w-full gap-5 flex items-center relative">
            <div className="relative">
              ...
              <div className="absolute bottom-0 right-0 bg-[#6c25ff] p-2 rounded-full cursor-pointer">
